...
/*
êµ??–´, ?˜?–´, ?ˆ˜?•™, ë¬¼ë¦¬, ?™”?•™, ?‚¬?šŒ, ì»´í“¨?„° ? ?ˆ˜ë¥?  ?…? ¥ë°›ì? ?›„, ì´ì , ?‰ê· ì„ êµ¬í•˜ê³? ?´?“¤ ëª¨ë‘?— ???•œ 
ë§‰ë?ê·¸ë˜?”„ë¥? ?•„?˜ ì¡°ê±´?— ë§ê²Œ ê·¸ë¦´ ?ˆ˜ ?ˆ?Š” ?”„ë¡œê·¸?¨?„ ?‘?„±?•˜?‹œ?˜¤.
?‹¨ ?‰ê· ì? ?†Œ?ˆ«? ?´?•˜?Š” ë²„ë¦¬ê³? ? •?ˆ˜ë¡? ì²˜ë¦¬ ?•©?‹ˆ?‹¤.
[ê²°ê³¼]
êµ??–´ ?˜?–´ ?ˆ˜?•™ ë¬¼ë¦¬ ?™”?•™ ?‚¬?šŒ ì»´í“¨?„° ? ?ˆ˜ë¥?(1 - 100) ?…? ¥?•˜?„¸?š”
...
public class Exam1 {
	public static void main(String[] args) {
		...
		int total = 0;
		int average = 0;
		System.out.println("êµ??–´ ?˜?–´ ?ˆ˜?•™ ë¬¼ë¦¬ ?™”?•™ ?‚¬?šŒ ì»´í“¨?„° ? ?ˆ˜ë¥?(1 - 100) ?…? ¥?•˜?„¸?š”");
		//Scanner score
        ...
        System.out.println("?‰ê·? : " + average);
        System.out.println("ìµœë? : " + max);
        System.out.println("ìµœì†Œ : " + min);
        
        //setting graph array
        String[][] s_a_graphArray = new String[11][11];
        String[] indexStringArray = {"","êµ??–´","?˜?–´","?ˆ˜?•™","ë¬¼ë¦¬","?™”?•™","?‚¬?šŒ","ì»´í“¨?„°","ìµœë?","ìµœì†Œ","?‰ê·?"};
        int judge = 0;
